	...
	public static MglgPostDTO toHtml(MglgPost mglgPost, MglgUser loginUser) {
		MglgPostDTO info = MglgPostDTO.builder()
					 ...
					 .restRating(mglgPost.getRestRating())
			          .hashTag1(mglgPost.getHashTag1() == null || mglgPost.getHashTag1().equals("")  ? "0": mglgPost.getHashTag1())
						.hashTag2(mglgPost.getHashTag2() == null || mglgPost.getHashTag2().equals("")  ? "0": mglgPost.getHashTag2())
						.hashTag3(mglgPost.getHashTag3() == null || mglgPost.getHashTag3().equals("")  ? "0": mglgPost.getHashTag3())
						.hashTag4(mglgPost.getHashTag4() == null || mglgPost.getHashTag4().equals("")  ? "0": mglgPost.getHashTag4())
						.hashTag5(mglgPost.getHashTag5() == null || mglgPost.getHashTag5().equals("")  ? "0": mglgPost.getHashTag5())
